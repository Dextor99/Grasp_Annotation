...
#         candidate_grippers_meshes.extend(k['meshes'])
    ...
    origin_spheres = visualize_gripper_origins_from_object_frame(min_opening_grippers, T_object_world, radius=2.0)
    ...
    if cyl0 is not None and cyl1 is not None:
        ...
        # 显示第i个
        vis_list = [cloud_down, cyl0, *object_world_axis] + [projections[i - 1]] + frame_arrows_list[i - 1]+min_opening_grippers_meshes + origin_spheres
